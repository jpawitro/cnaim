...
- Implemented:
    ...
    - General non-submarine location-factor execution path (tables 22-26)
    - CNAIM-defined neutral behavior for LV UGB and non-submarine land cables (`location_factor=1.0`)
